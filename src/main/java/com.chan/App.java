...
public class App {
    public static void main(String[] args) {
        ...
        Preference preference = Preference.getInstance(config);

        Logger.log("huo bi key", preference.getString("HUO_BI_ACCESS_KEY"));
        Logger.log("huo bi secret", preference.getString("HUO_BI_SECRET_KEY"));
